...
public class GrafedDashAttack : BaseState<GraftedStateMachine>
{
    public GrafedDashAttack(GraftedStateMachine currentContext, StateFactory<GraftedStateMachine> currentFactory)
