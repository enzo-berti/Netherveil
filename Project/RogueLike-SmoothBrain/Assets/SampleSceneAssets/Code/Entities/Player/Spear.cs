...
public class Spear : MonoBehaviour
{
    ...
    IEnumerator ThrowCoroutine(Vector3 _posToReach)
    {
        ...
        ApplyDamages(playerToPosToReachVec, posToReach, debugMode: true);
    ...
    IEnumerator ReturnCoroutine()
    {
        ...
        ApplyDamages(playerToSpearVec, spearPosition, debugMode: true);
    }
    ...
    void ApplyDamages(Vector3 playerToTargetPos, Vector3 lookAtPos, bool debugMode)
    {
        ...
        SpearThrowCollider.transform.parent.LookAt(lookAtPos);
